...
function glyphSettings()
{
    var out = [
         ...
         {gene: 'Akr1c18', color: '#054179',  glyphName: 'triangleUp'},
         {gene: 'Amigo2',        color: '#054179',   glyphName: 'star5'},
         {gene: 'Arc',        color: '#054179',   glyphName: 'star6'},
         {gene: 'Car4',      color: '#e6e6ff',   glyphName: 'plus'},
         {gene: 'Ccn2',        color: '#e6e6ff',   glyphName: 'circle'},
         {gene: 'Cdh9',         color: '#e6e6ff',   glyphName: 'asterisk'},
         {gene: 'Chrna6',        color: '#e6e6ff',   glyphName: 'point'},
         {gene: 'Cpne2',       color: '#44B300',   glyphName: 'square'},
         {gene: 'Cpne7',         color: '#e67300',   glyphName: 'triangleDown'},
         {gene: 'Crispld2',      color: '#e67300',   glyphName: 'triangleRight'},
         {gene: 'Ddit41',          color: '#e67300',   glyphName: 'asterisk'},
         {gene: 'Dkkl1',       color: '#e67300',   glyphName: 'point'},
         {gene: 'Fezf2',         color: '#e67300',   glyphName: 'square'},
         {gene: 'Gabrg1',         color: 'e67300',   glyphName: 'cross'},
         {gene: 'Gnb4',          color: '#e67300',   glyphName: 'plus'},
         {gene: 'Gpr83',        color: '#e67300',   glyphName: 'circle'},
         {gene: 'Gpr2',         color: '#e67300',   glyphName: 'triangleDown'},
         {gene: 'Zbtb20',        color: '#e67300',   glyphName: 'star5'},
         {gene: 'Ddit4l',        color: '#A5D6A7',   glyphName: 'point'},
         {gene: 'Gpr88',       color: '#A5D6A7',   glyphName: 'square'},
         {gene: 'Grik1',         color: '#A5D6A7',   glyphName: 'triangleDown'},
         {gene: 'Hs3st2',      color: '#A5D6A7',   glyphName: 'triangleRight'},
         {gene: 'Hsd11b1',          color: '#FFEB3B',   glyphName: 'asterisk'},
         {gene: 'Kcnip1',       color: '#FFEB3B',   glyphName: 'point'},
         {gene: 'Lgals1',         color: '#FFEB3B',   glyphName: 'square'},
         {gene: 'Lypd1',         color: '#FFEB3B',   glyphName: 'cross'},
         {gene: 'Lypd6',          color: '#FFEB3B',   glyphName: 'plus'},
         {gene: 'Mia',        color: '#FFEB3B',   glyphName: 'circle'},
         {gene: 'Mybpc1',         color: '#FFEB3B',   glyphName: 'triangleDown'},
         {gene: 'Myl4',        color: '#FFEB3B',   glyphName: 'star5'},
         {gene: 'Nek7',        color: '#F06292',   glyphName: 'point'},
         {gene: 'Nptx2',       color: '#F06292',   glyphName: 'square'},
         {gene: 'Nxph1',         color: '#F06292',   glyphName: 'triangleDown'},
         {gene: 'Parm1',      color: '#F06292',   glyphName: 'triangleRight'},
         {gene: 'Pdlim3',          color: '#F06292',   glyphName: 'asterisk'},
         {gene: 'Plpp4',       color: '#F06292',   glyphName: 'point'},
         {gene: 'Prss23',         color: '#F06292',   glyphName: 'square'},
         {gene: 'Qpct',         color: '#F06292',   glyphName: 'cross'},
         {gene: 'Scgn',          color: '#F06292',   glyphName: 'plus'},
         {gene: 'Sema5a',        color: '#F06292',   glyphName: 'circle'},
         {gene: 'Serpine2',         color: '#F06292',   glyphName: 'triangleDown'},
         {gene: 'Spp1',        color: '#F06292',   glyphName: 'star5'}, 
         {gene: 'Tafa1',         color: '#F06292',   glyphName: 'cross'},
         {gene: 'Tnfaip6',          color: '#F06292',   glyphName: 'plus'},
         {gene: 'Tnfaip8l3',        color: '#F06292',   glyphName: 'circle'},
         {gene: 'Tnmd',         color: '#F06292',   glyphName: 'triangleDown'},
         {gene: 'Tpbg',        color: '#F06292',   glyphName: 'star5'}, 
         {gene: 'Tshz2',        color: '#F06292',   glyphName: 'star5'}, 
