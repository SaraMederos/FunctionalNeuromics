...
// 6. spotSize: Scalar. Use this to adjust the screen-size of your spots before they morph into glyphs. 
 function config() { return {cellData: {mediaLink: '../../data/cellData.tsv', size: "3584982"},

 geneData: {mediaLink: '../../data/geneData.tsv', size: "50046027"},

 cellBoundaries: {mediaLink: '../../data/cellBoundaries.tsv', size: "2374701"},

 roi: {"x0": 0, "x1": 9541, "y0": 0, "y1": 7789 },

 zoomLevels: 10, // maximum zoom levels. Leave that at 10.

 layers: {  'tdTom': '../../../tdTomatoTiles/{z}/{y}/{x}.jpg',

            'EGFP': '../../../EGFPTiles/{z}/{y}/{x}.jpg',

            'DAPI': '../../../BackgroundTiles/{z}/{y}/{x}.jpg',

            'cellPose': '../../../CellPoseMaskTiles/{z}/{y}/{x}.jpg',

           'empty': '',}, "spotSize": 0.0625} }